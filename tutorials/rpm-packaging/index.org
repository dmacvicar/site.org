...
=$ zypper info --provides patterns-openSUSE-laptop= would show you some
of the magic behind patterns (equivalent to
=rpm -q --provides patterns-openSUSE-laptop=).
...
[[http://openbuildservice.org/help/materials/][Material]] section of the
...
[[../../assets/images/tutorials/rpm-packaging-tutorial/gqlplus-obs.png]]
