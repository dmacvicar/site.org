...
In mid-2014 I wrote about [SUSE Manager 2.1]({% post_url 2014-06-11-suse-manager-2-1 %}). It was an important release for us because at that point we became very active upstream, to the point that on a typical day, a considerable chunk of the open pull requests came from SUSE, including a refreshed mobile-enabled user interface.
